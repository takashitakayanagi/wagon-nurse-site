...
/** 利用規約（雛形）。[仮] は運営者・法務確認のうえ差し替えてください。 */
  ...
  return (
    <LegalPage title="利用規約">
      ...
      <section>
        ...
        <p>[仮] 法令違反行為、当社または第三者の権利を侵害する行為、コンテンツの無断転載・複製などを禁止します。</p>
      </section>
      <section>
        <h2 className="text-base font-bold">第3条（有料講座について）</h2>
        <p>
          [仮] 有料講座の申し込みは任意です。料金・受講条件・視聴期間などは各講座の案内に従います。本サービスは看護師国家試験の合格を保証するものではありません。
        </p>
      </section>
      <section>
        <h2 className="text-base font-bold">第4条（免責事項）</h2>
        <p>[仮] 当社は、本サービスの利用により生じた損害について、当社の故意または重過失による場合を除き責任を負いません。</p>
      </section>
      <section>
