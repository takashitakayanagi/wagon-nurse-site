...
/** プライバシーポリシー（雛形）。[仮] は運営者・法務確認のうえ差し替えてください。 */
  ...
  return (
    <LegalPage title="プライバシーポリシー">
      ...
      <section>
        ...
        <p>
          [仮] 氏名・メールアドレス・LINEのユーザー識別情報・アクセス解析情報などを取得する場合があります。取得項目は運営実態に合わせて記載してください。
        </p>
      </section>
      <section>
        <h2 className="text-base font-bold">2. 利用目的</h2>
        <p>[仮] 本サービスの案内・お問い合わせ対応・サービス改善・各種ご連絡のために利用します。</p>
      </section>
      <section>
        <h2 className="text-base font-bold">3. アクセス解析ツール</h2>
        <p>
          [仮] 本サービスでは Google Analytics・Meta Pixel などのアクセス解析ツールを利用する場合があります。これらはCookie等を使用し、個人を特定しない形で利用状況を収集します。
        </p>
      </section>
      <section>
        <h2 className="text-base font-bold">4. 第三者提供</h2>
        <p>[仮] 法令に基づく場合を除き、ご本人の同意なく個人情報を第三者に提供しません。</p>
      </section>
      <section>
